...
namespace dbms {
    ...
    public partial class ModelDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string FullName, string Email, string Address, string Phone, bool Gender) {
...
namespace dbms.ModelDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([Id], [FullName], [Email], [Address], [Phone], [Ge" +
                "nder]) VALUES (@Id, @FullName, @Email, @Address, @Phone, @Gender);\r\nSELECT Id, F" +
                "ullName, Email, Address, Phone, Gender FROM Customers WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [Id] = @Id, [FullName] = @FullName, [Email] = @Email, [Address] = @Address, [Phone] = @Phone, [Gender] = @Gender WHERE (([Id] = @Original_Id) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)));
SELECT Id, FullName, Email, Address, Phone, Gender FROM Customers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::dbms.Properties.Settings.Default.cn;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FullName, Email, Address, Phone, Gender FROM dbo.Customers";
        ...
        public virtual int Delete(int Original_Id, string Original_FullName, string Original_Email, string Original_Address, string Original_Phone, global::System.Nullable<bool> Original_Gender) {
        ...
        public virtual int Insert(int Id, string FullName, string Email, string Address, string Phone, global::System.Nullable<bool> Gender) {
        ...
        public virtual int Update(int Id, string FullName, string Email, string Address, string Phone, global::System.Nullable<bool> Gender, int Original_Id, string Original_FullName, string Original_Email, string Original_Address, string Original_Phone, global::System.Nullable<bool> Original_Gender) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, string Email, string Address, string Phone, global::System.Nullable<bool> Gender, int Original_Id, string Original_FullName, string Original_Email, string Original_Address, string Original_Phone, global::System.Nullable<bool> Original_Gender) {
            return this.Update(Original_Id, FullName, Email, Address, Phone, Gender, Original_Id, Original_FullName, Original_Email, Original_Address, Original_Phone, Original_Gender);
        }
    }
